...
function Login() {
  ...
  const { login, isAuthenticated, loading, authError } = useAuthContext();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call login function but don't expect a return value
      await login(formData.email, formData.password);
      // The component will redirect when isAuthenticated becomes true
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-amber-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-emerald-900">Welcome back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-emerald-600 hover:text-emerald-500 transition duration-300">
        ...
        <div className="text-center text-sm text-gray-600">
          <p>
            ...
            <Link to="/register" className="font-medium text-emerald-600 hover:text-emerald-500 transition duration-300">
              Sign up
            </Link>
          </p>
        </div>
